import fs from 'fs';
import type { ResponseLike } from 'first-stainless-mcp/internal/to-file';
import { toFile } from 'first-stainless-mcp/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('first-stainless-mcp/core/uploads');
    await expect(
