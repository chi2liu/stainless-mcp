# First Stainless Mcp TypeScript MCP Server
...
```sh
git clone git@github.com:stainless-sdks/first-stainless-mcp-typescript.git
...
> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npx -y first-stainless-mcp-mcp`
...
{
  "mcpServers": {
    "first_stainless_mcp_api": {
      "command": "node",
      "args": [
        "/path/to/local/first-stainless-mcp-typescript/packages/mcp-server",
        "--client=claude",
        "--tools=all"
      ],
      "env": {
...
import { server, endpoints, init } from "first-stainless-mcp-mcp/server";

// import a specific tool
import createPet from "first-stainless-mcp-mcp/tools/pet/create-pet";
