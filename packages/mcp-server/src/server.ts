...
import { ClientOptions } from 'first-stainless-mcp';
...
export { ClientOptions } from 'first-stainless-mcp';
...
export function initMcpServer(params: {
  ...
  const client = new FirstStainlessMcp(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new FirstStainlessMcp({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
